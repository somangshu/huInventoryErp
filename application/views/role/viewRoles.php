...
<?php $this->load->view('common/header'); ?>
    ...
    <div class="activ_rols"><span>Active Roles </span><?php if (isset($messageD)){ echo $messageD; } ?> </div> 
...
<table id="rounded-corner" >
    ...
    <?php foreach ($allRolesArray as $temp){ ?>
    	<tr>
            ...
            <td>
            <?php if (isset($checkRoleArray) && $temp['role_status']=='No'); else {?>
            <a href="/deleteRole/<?php echo $temp['role_id']; ?> " onclick="return confirmDeletion();" class="ask"><img src="/public/images/trash.png" alt="" title="Delete Role" border="0" /></a>
            <?php } ?>
            </td>
        </tr>
    <?php } ?>            
     ...
     <a href="/viewDeletedRoles" class="bt_red"><span class="bt_red_lft"></span><strong>View Inactive Roles</strong><span class="bt_red_r"></span></a> 
